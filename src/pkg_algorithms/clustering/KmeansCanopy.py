...
class KMeansCanopy(BaseEstimator, TransformerMixin):
...
color = ['g','c','y']
# print(clf.clusters)
for centroid in canopy.centroids:
    plt.scatter(canopy.centroids[centroid][0], canopy.centroids[centroid][1], marker='o', color=color[centroid])
